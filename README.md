...
收集整理这份资料灵感来自于 [trip\_to\_iOS](https://github.com/Aufree/trip-to-iOS) ⭐ 7,870 | 🐛 3 | 🌐 Objective-C | 📅 2022-05-17, 征得同意引用了该资料的开头描述
...
| [jadx](https://github.com/skylot/jadx) ⭐ 50,479 \| 🐛 448 \| 🌐 Java \| 📅 2026-09-12                                              | 一个 Android 反编译神器, 不同于常见的 [dex2jar](https://github.com/pxb1988/dex2jar) ⭐ 13,139 \| 🐛 379 \| 🌐 Java \| 📅 2024-07-21, 这个反编译器生成代码的 try/catch 次数更少, View也不再是数字 id 了, 可读性更高                                                                                             |
...
| [folding-plugin](https://github.com/dmytrodanylyk/folding-plugin) ⭐ 1,510 \| 🐛 13 \| 🌐 Java \| 📅 2015-11-14                     | layout 文件夹里的布局文件一般很长很长没有目录, 这个插件就可以把 layout 分好层级结构, 类似 src 下目录结构                                                                                                                                                                                                      |
| [CodeGlance](https://github.com/Vektah/CodeGlance) ⭐ 1,051 \| 🐛 64 \| 🌐 Kotlin \| 📅 2021-06-15                                  | 在编辑代码最右侧, 显示一块代码小地图                                                                                                                                                                                                                                                   |
...
| [AndroidLocalizationer](https://github.com/westlinkin/AndroidLocalizationer) ⭐ 822 \| 🐛 32 \| 🌐 Java \| 📅 2016-04-21            | 可用于将项目中的 string 资源自动翻译为其他语言的插件, 其翻译支持使用 Microsoft Translator 或 Google Translation                                                                                                                                                                                     |
...
| [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,995 \| 🐛 134 \| 🌐 Kotlin \| 📅 2026-09-15                                | 良心企业 Square 最近刚开源的一个非常有用的工具, 强烈推荐, 帮助你在开发阶段方便的检测出内存泄露的问题, 使用起来更简单方便, 而且我们团队第一时间使用帮助我们发现了不少问题, 英文不好的这里有雷锋同志翻译的中文版 [LeakCanary 中文使用说明](http://www.liaohuqiu.net/cn/posts/leak-canary-read-me/)                                                                          |
...
| [MIUI 便签](https://github.com/MiCode/Notes) ⭐ 2,109 \| 🐛 17 \| 🌐 Java \| 📅 2023-03-29                                    | MiCode 便签是小米便签的社区开源版, 由 MIUI 团队（ww\.miui.com）发起并贡献第一批代码, 遵循 NOTICE 文件所描述的开源协议                                                                                                                                                   |
| [贝壳单词](https://github.com/drakeet/Seashell-app)                                                                            | 开发者是许晓峰(Drakeet), 获得豌豆荚设计奖, 这个是初期版本, 新版没有开源, 但是在博主的博客当中将一些新版的内容都剥离出来写成了文章,可以去学习一下                                                                                                                                               |
| [Muzei Live Wallpaper](https://github.com/romannurik/muzei) ⭐ 4,944 \| 🐛 39 \| 🌐 Kotlin \| 📅 2026-09-14                 | 开发者是 Ian Lake , 就职于 Google, 这款是定时更换桌面精美壁纸 App                                                                                                                                                                                   |
...
| [ZXing](https://github.com/zxing/zxing) ⭐ 34,092 \| 🐛 3 \| 🌐 Java \| 📅 2026-09-07                                       | 二维码扫描工具,市场上许多应用的二维码扫描工具都是从这个修改得到的                                                                                                                                                                                               |
...
| [ChaseWhisplyProject](https://github.com/tvbarthel/ChaseWhisplyProject) ⭐ 552 \| 🐛 8 \| 🌐 Java \| 📅 2024-03-16          | 开启摄像头在你所在位置寻找鬼魂, 进行打鬼游戏                                                                                                                                                                                                         |
| [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,159 \| 🐛 371 \| 🌐 Java \| 📅 2026-09-12                       | AntennaPod 是一个自由, 开源的播客客户端, 支持 Atom 和 RSS Feed                                                                                                                                                                                  |
...
| [proxydroid](https://github.com/madeye/proxydroid) ⭐ 2,553 \| 🐛 5 \| 🌐 Kotlin \| 📅 2026-05-12                           | ProxyDroid 是一个帮助你在你的 Android 设备上设置代理 (HTTP / SOCKS4 / SOCKS5)                                                                                                                                                                   |
...
| [Plaid](https://github.com/nickbutcher/plaid) ⭐ 16,175 \| 🐛 102 \| 🌐 Kotlin \| 📅 2024-01-04                             | 一个遵循 Material Design 的一个设计新闻客户端，里面的一些完全MD的一些特效很棒，同时整个客户端的框架设计也很有参考意义                                                                                                                                                            |
| [SimplifyReader](https://github.com/SkillCollege/SimplifyReader) ⭐ 4,540 \| 🐛 41 \| 🌐 Java \| 📅 2021-09-17              | 一款基于 Google Material Design 设计开发的 Android 客户端, 包括新闻简读, 图片浏览, 视频爽看, 音乐轻听以及二维码扫描五个子模块, 项目采取的是MVP架构开发                                                                                                                              |
...
* [awesome 系列之终极版](https://github.com/sindresorhus/awesome) ⭐ 506,554 | 🐛 106 | 📅 2026-09-02
* [awesome\_android\_UI](https://github.com/wasabeef/awesome-android-ui) ⭐ 57,601 | 🐛 39 | 📅 2026-06-05
* [awesome\_java](https://github.com/akullpp/awesome-java) ⭐ 49,027 | 🐛 20 | 📅 2026-08-24
* [awesome-adb](https://github.com/mzlogin/awesome-adb) ⭐ 12,450 | 🐛 52 | 📅 2024-12-18
* [awesome\_android(2)](https://github.com/JStumpp/awesome-android) ⭐ 12,330 | 🐛 97 | 📅 2025-10-27
* [awesome android(1)](https://github.com/snowdream/awesome-android) ⚠️ Archived
* [awesome\_materialdesign](https://github.com/lightSky/Awesome-MaterialDesign) ⭐ 5,860 | 🐛 15 | 📅 2018-01-06
* [awesome\_android\_libraries](https://github.com/wasabeef/awesome-android-libraries) ⭐ 5,532 | 🐛 64 | 📅 2023-08-29
...
* [AndroidViewAnimations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,439 | 🐛 68 | 🌐 Java | 📅 2021-08-18
...
* [Material Design Android Library ](https://github.com/navasmdc/MaterialDesignLibrary) ⭐ 8,913 | 🐛 254 | 🌐 Java | 📅 2023-05-28(Material Design 开源库, 很多效果可以直接拿来用)
* [Material Design 教程(中文版)](https://github.com/1sters/material_design_zh_2) ⭐ 1,172 | 🐛 4 | 📅 2019-04-03
...
* [awesome-design](https://github.com/gztchan/awesome-design/) ⭐ 17,537 | 🐛 63 | 📅 2024-07-04
...
* [Android 开源项目汇总 ](https://github.com/Trinea/android-open-project) ⭐ 31,805 | 🐛 32 | 📅 2026-03-25(Trinea 大神收集的)
...
* [java-design-patterns](https://github.com/iluwatar/java-design-patterns#model-view-presenter) ⭐ 94,696 | 🐛 128 | 🌐 Java | 📅 2026-09-13
* [Android源码设计模式分析项目](https://github.com/simple-android-framework-exchange/android_design_patterns_analysis) ⭐ 2,925 | 🐛 0 | 🌐 Java | 📅 2023-09-26
...
* [AndroidNote](https://github.com/CharonChui/AndroidNote) ⭐ 3,937 | 🐛 4 | 📅 2026-09-05
* [Android-Tips](https://github.com/tangqi92/Android-Tips) ⭐ 3,214 | 🐛 2 | 🌐 Java | 📅 2018-12-27
* [Java 反射最佳实践](https://github.com/tianzhijiexian/Android-Best-Practices/blob/master/2015.9/reflect/reflect.md) ⭐ 3,124 | 🐛 0 | 📅 2019-01-08
* [Adapter 优化方案的探索](https://github.com/tianzhijiexian/Android-Best-Practices/blob/master/2015.10/adapter/adapter.md) ⭐ 3,124 | 🐛 0 | 📅 2019-01-08
...
* [国内一线互联网公司内部面试题库](https://github.com/JackyAndroid/AndroidInterview-Q-A) ⭐ 8,003 | 🐛 4 | 🌐 JavaScript | 📅 2023-07-18
...
* [git-tips](https://github.com/git-tips/tips) ⭐ 21,722 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-13(Git 命令集合)
...
* [Android 开发人员不得不收集的代码](https://github.com/Blankj/AndroidUtilCode) ⭐ 33,622 | 🐛 328 | 🌐 Java | 📅 2024-08-15
...
* [Android 开发收藏夹](https://github.com/ruijun/Android-Dev-Favorites) ⭐ 1,532 | 🐛 1 | 📅 2019-10-09
* [Android 架构合集](https://github.com/Juude/Awesome-Android-Architecture) ⭐ 1,511 | 🐛 4 | 📅 2019-03-05
...
点击[该链接](https://github.com/Freelander/Android_Data/graphs/contributors) ⭐ 8,948 | 🐛 10 | 🌐 Java | 📅 2024-01-15查看该项目所有贡献者
