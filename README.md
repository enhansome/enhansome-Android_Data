...
收集整理这份资料灵感来自于 [trip\_to\_iOS](https://github.com/Aufree/trip-to-iOS) ⭐ 7,877 | 🐛 3 | 🌐 Objective-C | 📅 2022-05-17, 征得同意引用了该资料的开头描述
...
(附上: 由 [@脉脉不得语](http://weibo.com/234959219) 收集维护超多开发工具下载地址 [AndroidDevTools](https://github.com/inferjay/AndroidDevTools) ⭐ 8,052 | 🐛 6 | 📅 2026-08-07, 后五个工具资料在 [stormzhang](http://stormzhang.com/) 博客中找到的,[地址](http://stormzhang.com/android/2015/05/26/android-tools/))
...
| [jadx](https://github.com/skylot/jadx) ⭐ 50,128 \| 🐛 443 \| 🌐 Java \| 📅 2026-08-05                                              | 一个 Android 反编译神器, 不同于常见的 [dex2jar](https://github.com/pxb1988/dex2jar) ⭐ 13,132 \| 🐛 379 \| 🌐 Java \| 📅 2024-07-21, 这个反编译器生成代码的 try/catch 次数更少, View也不再是数字 id 了, 可读性更高                                                                                             |
...
| [checkstyle-idea](https://github.com/jshiell/checkstyle-idea) ⭐ 917 \| 🐛 10 \| 🌐 Java \| 📅 2026-08-19                           | Checkstyle-idea 是一款检查自己写的代码是否符合规范的插件, 该插件是根据 checkstyle.xml 文件来检查的, checkstyle.xml 文件可以由自己自己定义, 也可以使用一些大公司定义的规范, 如果不懂得如何定义, 可以查看 [官方文档](http://checkstyle.sourceforge.net/checks.html), 该插件的详细介绍以及使用, 可以看一下咕咚大侠写的 [文章](http://gudong.name/2016/04/07/checkstyle.html) |
...
| [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,976 \| 🐛 129 \| 🌐 Kotlin \| 📅 2026-08-11                                | 良心企业 Square 最近刚开源的一个非常有用的工具, 强烈推荐, 帮助你在开发阶段方便的检测出内存泄露的问题, 使用起来更简单方便, 而且我们团队第一时间使用帮助我们发现了不少问题, 英文不好的这里有雷锋同志翻译的中文版 [LeakCanary 中文使用说明](http://www.liaohuqiu.net/cn/posts/leak-canary-read-me/)                                                                          |
...
| [github客户端](https://github.com/pockethub/PocketHub) ⭐ 9,360 \| 🐛 135 \| 🌐 Java \| 📅 2023-06-06                          | 开源者 github 团队, 支持项目的 lssues 和 Gists 并集成了新闻 feed 以便及时获取来自组织好友和资料库的更新信息, 还提供了一个用于快速访问你创建,监控以及发布 issue 面板, 可查看并将问题加到收藏夹                                                                                                            |
...
| [MIUI 便签](https://github.com/MiCode/Notes) ⭐ 2,097 \| 🐛 17 \| 🌐 Java \| 📅 2023-03-29                                    | MiCode 便签是小米便签的社区开源版, 由 MIUI 团队（ww\.miui.com）发起并贡献第一批代码, 遵循 NOTICE 文件所描述的开源协议                                                                                                                                                   |
| [贝壳单词](https://github.com/drakeet/Seashell-app)                                                                            | 开发者是许晓峰(Drakeet), 获得豌豆荚设计奖, 这个是初期版本, 新版没有开源, 但是在博主的博客当中将一些新版的内容都剥离出来写成了文章,可以去学习一下                                                                                                                                               |
| [Muzei Live Wallpaper](https://github.com/romannurik/muzei) ⭐ 4,935 \| 🐛 39 \| 🌐 Kotlin \| 📅 2026-08-11                 | 开发者是 Ian Lake , 就职于 Google, 这款是定时更换桌面精美壁纸 App                                                                                                                                                                                   |
| [四次元-新浪微博客户端](https://github.com/qii/weiciyuan) ⭐ 2,599 \| 🐛 64 \| 🌐 Java \| 📅 2016-08-14                               | 一个仿新浪微博客户端 App, 基本都含有新浪微博的功能, 开源团队写了一份 wiki 文档, 可以去学习一下该 App 是如何实现的                                                                                                                                                             |
...
| [ZXing](https://github.com/zxing/zxing) ⭐ 34,070 \| 🐛 1 \| 🌐 Java \| 📅 2026-08-17                                       | 二维码扫描工具,市场上许多应用的二维码扫描工具都是从这个修改得到的                                                                                                                                                                                               |
...
| [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,089 \| 🐛 366 \| 🌐 Java \| 📅 2026-08-14                       | AntennaPod 是一个自由, 开源的播客客户端, 支持 Atom 和 RSS Feed                                                                                                                                                                                  |
...
| [proxydroid](https://github.com/madeye/proxydroid) ⭐ 2,536 \| 🐛 5 \| 🌐 Kotlin \| 📅 2026-05-12                           | ProxyDroid 是一个帮助你在你的 Android 设备上设置代理 (HTTP / SOCKS4 / SOCKS5)                                                                                                                                                                   |
...
* [awesome 系列之终极版](https://github.com/sindresorhus/awesome) ⭐ 497,651 | 🐛 102 | 📅 2026-08-18
* [awesome\_android\_UI](https://github.com/wasabeef/awesome-android-ui) ⭐ 57,247 | 🐛 39 | 📅 2026-06-05
* [awesome\_java](https://github.com/akullpp/awesome-java) ⭐ 48,783 | 🐛 10 | 📅 2026-08-17
* [awesome-adb](https://github.com/mzlogin/awesome-adb) ⭐ 12,422 | 🐛 52 | 📅 2024-12-18
* [awesome\_android(2)](https://github.com/JStumpp/awesome-android) ⭐ 12,285 | 🐛 93 | 📅 2025-10-27
* [awesome android(1)](https://github.com/snowdream/awesome-android) ⚠️ Archived
* [awesome\_materialdesign](https://github.com/lightSky/Awesome-MaterialDesign) ⭐ 5,864 | 🐛 15 | 📅 2018-01-06
* [awesome\_android\_libraries](https://github.com/wasabeef/awesome-android-libraries) ⭐ 5,527 | 🐛 64 | 📅 2023-08-29
* [android-dynamic-load-awesome](https://github.com/liaohuqiu/android-dynamic-load-awesome) ⭐ 316 | 🐛 0 | 📅 2016-03-02

## 动画系列

* [Material-Animations](https://github.com/lgvalle/Material-Animations) ⭐ 13,542 | 🐛 20 | 🌐 Java | 📅 2019-04-02
...
* [Material Design Android Library ](https://github.com/navasmdc/MaterialDesignLibrary) ⭐ 8,918 | 🐛 253 | 🌐 Java | 📅 2023-05-28(Material Design 开源库, 很多效果可以直接拿来用)
* [Material Design 教程(中文版)](https://github.com/1sters/material_design_zh_2) ⭐ 1,174 | 🐛 4 | 📅 2019-04-03
...
* [awesome-design](https://github.com/gztchan/awesome-design/) ⭐ 17,426 | 🐛 61 | 📅 2024-07-04

## 开源库收集

* [Android Libraries and Resources ](http://alamkanak.github.io/android-libraries-and-resources/)
* [Android Arsenal ](http://android-arsenal.com/)(一个专门收集 android 开源库的网站, 网站经常更新)
* [Android 开源项目汇总 ](https://github.com/Trinea/android-open-project) ⭐ 31,819 | 🐛 31 | 📅 2026-03-25(Trinea 大神收集的)
...
* [java-design-patterns](https://github.com/iluwatar/java-design-patterns#model-view-presenter) ⭐ 94,588 | 🐛 137 | 🌐 Java | 📅 2026-08-17
...
* [Android 开发最佳实践](https://github.com/futurice/android-best-practices/blob/master/translations/Chinese/README.cn.md) ⭐ 20,443 | 🐛 30 | 📅 2021-10-01
* [AndroidNote](https://github.com/CharonChui/AndroidNote) ⭐ 3,931 | 🐛 4 | 📅 2026-08-17
* [Android-Tips](https://github.com/tangqi92/Android-Tips) ⭐ 3,216 | 🐛 2 | 🌐 Java | 📅 2018-12-27
* [Java 反射最佳实践](https://github.com/tianzhijiexian/Android-Best-Practices/blob/master/2015.9/reflect/reflect.md) ⭐ 3,127 | 🐛 0 | 📅 2019-01-08
* [Adapter 优化方案的探索](https://github.com/tianzhijiexian/Android-Best-Practices/blob/master/2015.10/adapter/adapter.md) ⭐ 3,127 | 🐛 0 | 📅 2019-01-08
...
* [国内一线互联网公司内部面试题库](https://github.com/JackyAndroid/AndroidInterview-Q-A) ⭐ 7,998 | 🐛 4 | 🌐 JavaScript | 📅 2023-07-18
...
* [Android 开发人员不得不收集的代码](https://github.com/Blankj/AndroidUtilCode) ⭐ 33,635 | 🐛 328 | 🌐 Java | 📅 2024-08-15
* [TimLiu-Android](https://github.com/Tim9Liu9/TimLiu-Android) ⭐ 3,053 | 🐛 1 | 📅 2019-08-19(TimLiu 总结的 Android 开源项目及库)
* [Android 开发中的日常积累](https://github.com/lizhangqu/CoreLink) ⭐ 2,721 | 🐛 1 | 🌐 Java | 📅 2018-12-29
...
点击[该链接](https://github.com/Freelander/Android_Data/graphs/contributors) ⭐ 8,937 | 🐛 9 | 🌐 Java | 📅 2024-01-15查看该项目所有贡献者
