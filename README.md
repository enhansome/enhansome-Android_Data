...
收集整理这份资料灵感来自于 [trip\_to\_iOS](https://github.com/Aufree/trip-to-iOS) ⭐ 7,875 | 🐛 3 | 🌐 Objective-C | 📅 2022-05-17, 征得同意引用了该资料的开头描述
...
(附上: 由 [@脉脉不得语](http://weibo.com/234959219) 收集维护超多开发工具下载地址 [AndroidDevTools](https://github.com/inferjay/AndroidDevTools) ⭐ 8,058 | 🐛 6 | 📅 2026-09-01, 后五个工具资料在 [stormzhang](http://stormzhang.com/) 博客中找到的,[地址](http://stormzhang.com/android/2015/05/26/android-tools/))
...
| [jadx](https://github.com/skylot/jadx) ⭐ 50,321 \| 🐛 443 \| 🌐 Java \| 📅 2026-09-02                                              | 一个 Android 反编译神器, 不同于常见的 [dex2jar](https://github.com/pxb1988/dex2jar) ⭐ 13,134 \| 🐛 379 \| 🌐 Java \| 📅 2024-07-21, 这个反编译器生成代码的 try/catch 次数更少, View也不再是数字 id 了, 可读性更高                                                                                             |
...
| [checkstyle-idea](https://github.com/jshiell/checkstyle-idea) ⭐ 917 \| 🐛 2 \| 🌐 Java \| 📅 2026-08-31                            | Checkstyle-idea 是一款检查自己写的代码是否符合规范的插件, 该插件是根据 checkstyle.xml 文件来检查的, checkstyle.xml 文件可以由自己自己定义, 也可以使用一些大公司定义的规范, 如果不懂得如何定义, 可以查看 [官方文档](http://checkstyle.sourceforge.net/checks.html), 该插件的详细介绍以及使用, 可以看一下咕咚大侠写的 [文章](http://gudong.name/2016/04/07/checkstyle.html) |
...
| [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,988 \| 🐛 132 \| 🌐 Kotlin \| 📅 2026-08-31                                | 良心企业 Square 最近刚开源的一个非常有用的工具, 强烈推荐, 帮助你在开发阶段方便的检测出内存泄露的问题, 使用起来更简单方便, 而且我们团队第一时间使用帮助我们发现了不少问题, 英文不好的这里有雷锋同志翻译的中文版 [LeakCanary 中文使用说明](http://www.liaohuqiu.net/cn/posts/leak-canary-read-me/)                                                                          |
...
| [Muzei Live Wallpaper](https://github.com/romannurik/muzei) ⭐ 4,943 \| 🐛 40 \| 🌐 Kotlin \| 📅 2026-09-02                 | 开发者是 Ian Lake , 就职于 Google, 这款是定时更换桌面精美壁纸 App                                                                                                                                                                                   |
...
| [知乎专栏](https://github.com/bxbxbai/ZhuanLan) ⭐ 722 \| 🐛 11 \| 🌐 Java \| 📅 2017-04-17                                     | 开发者是白瓦力, 项目结构清晰, 代码分包合理, 很棒. 很适合新手去学习如何搭建一个 App 结构, 熟悉开发一个完整 App 的流程                                                                                                                                                            |
...
| [ZXing](https://github.com/zxing/zxing) ⭐ 34,081 \| 🐛 0 \| 🌐 Java \| 📅 2026-09-01                                       | 二维码扫描工具,市场上许多应用的二维码扫描工具都是从这个修改得到的                                                                                                                                                                                               |
...
| [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,123 \| 🐛 375 \| 🌐 Java \| 📅 2026-08-29                       | AntennaPod 是一个自由, 开源的播客客户端, 支持 Atom 和 RSS Feed                                                                                                                                                                                  |
...
| [proxydroid](https://github.com/madeye/proxydroid) ⭐ 2,548 \| 🐛 5 \| 🌐 Kotlin \| 📅 2026-05-12                           | ProxyDroid 是一个帮助你在你的 Android 设备上设置代理 (HTTP / SOCKS4 / SOCKS5)                                                                                                                                                                   |
...
* [awesome 系列之终极版](https://github.com/sindresorhus/awesome) ⭐ 502,541 | 🐛 105 | 📅 2026-09-02
* [awesome\_android\_UI](https://github.com/wasabeef/awesome-android-ui) ⭐ 57,448 | 🐛 39 | 📅 2026-06-05
* [awesome\_java](https://github.com/akullpp/awesome-java) ⭐ 48,917 | 🐛 7 | 📅 2026-08-24
* [awesome-adb](https://github.com/mzlogin/awesome-adb) ⭐ 12,435 | 🐛 52 | 📅 2024-12-18
* [awesome\_android(2)](https://github.com/JStumpp/awesome-android) ⭐ 12,309 | 🐛 96 | 📅 2025-10-27
...
* [AndroidViewAnimations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,442 | 🐛 67 | 🌐 Java | 📅 2021-08-18
...
* [awesome-design](https://github.com/gztchan/awesome-design/) ⭐ 17,484 | 🐛 61 | 📅 2024-07-04
...
* [Android 开源项目汇总 ](https://github.com/Trinea/android-open-project) ⭐ 31,810 | 🐛 32 | 📅 2026-03-25(Trinea 大神收集的)
...
* [java-design-patterns](https://github.com/iluwatar/java-design-patterns#model-view-presenter) ⭐ 94,636 | 🐛 127 | 🌐 Java | 📅 2026-08-31
...
* [AndroidNote](https://github.com/CharonChui/AndroidNote) ⭐ 3,935 | 🐛 4 | 📅 2026-08-29
...
* [git-tips](https://github.com/git-tips/tips) ⭐ 21,724 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-10(Git 命令集合)
...
点击[该链接](https://github.com/Freelander/Android_Data/graphs/contributors) ⭐ 8,946 | 🐛 9 | 🌐 Java | 📅 2024-01-15查看该项目所有贡献者
