...
| [jadx](https://github.com/skylot/jadx) ⭐ 50,313 \| 🐛 442 \| 🌐 Java \| 📅 2026-08-31                                              | 一个 Android 反编译神器, 不同于常见的 [dex2jar](https://github.com/pxb1988/dex2jar) ⭐ 13,136 \| 🐛 379 \| 🌐 Java \| 📅 2024-07-21, 这个反编译器生成代码的 try/catch 次数更少, View也不再是数字 id 了, 可读性更高                                                                                             |
...
| [checkstyle-idea](https://github.com/jshiell/checkstyle-idea) ⭐ 918 \| 🐛 2 \| 🌐 Java \| 📅 2026-08-31                            | Checkstyle-idea 是一款检查自己写的代码是否符合规范的插件, 该插件是根据 checkstyle.xml 文件来检查的, checkstyle.xml 文件可以由自己自己定义, 也可以使用一些大公司定义的规范, 如果不懂得如何定义, 可以查看 [官方文档](http://checkstyle.sourceforge.net/checks.html), 该插件的详细介绍以及使用, 可以看一下咕咚大侠写的 [文章](http://gudong.name/2016/04/07/checkstyle.html) |
...
| [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,987 \| 🐛 132 \| 🌐 Kotlin \| 📅 2026-08-31                                | 良心企业 Square 最近刚开源的一个非常有用的工具, 强烈推荐, 帮助你在开发阶段方便的检测出内存泄露的问题, 使用起来更简单方便, 而且我们团队第一时间使用帮助我们发现了不少问题, 英文不好的这里有雷锋同志翻译的中文版 [LeakCanary 中文使用说明](http://www.liaohuqiu.net/cn/posts/leak-canary-read-me/)                                                                          |
...
| [更多](https://github.com/android-cn/android-dev-cn) ⭐ 2,892 \| 🐛 5 \| 📅 2016-09-21 | 这里面收集了很多国内外开发者的信息, 大家可以去看看                                                                                                                                                                                                              |
...
| [Muzei Live Wallpaper](https://github.com/romannurik/muzei) ⭐ 4,942 \| 🐛 40 \| 🌐 Kotlin \| 📅 2026-09-02                 | 开发者是 Ian Lake , 就职于 Google, 这款是定时更换桌面精美壁纸 App                                                                                                                                                                                   |
...
| [ZXing](https://github.com/zxing/zxing) ⭐ 34,076 \| 🐛 0 \| 🌐 Java \| 📅 2026-09-01                                       | 二维码扫描工具,市场上许多应用的二维码扫描工具都是从这个修改得到的                                                                                                                                                                                               |
...
| [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,122 \| 🐛 373 \| 🌐 Java \| 📅 2026-08-29                       | AntennaPod 是一个自由, 开源的播客客户端, 支持 Atom 和 RSS Feed                                                                                                                                                                                  |
...
| [SimplifyReader](https://github.com/SkillCollege/SimplifyReader) ⭐ 4,543 \| 🐛 41 \| 🌐 Java \| 📅 2021-09-17              | 一款基于 Google Material Design 设计开发的 Android 客户端, 包括新闻简读, 图片浏览, 视频爽看, 音乐轻听以及二维码扫描五个子模块, 项目采取的是MVP架构开发                                                                                                                              |
...
* [awesome 系列之终极版](https://github.com/sindresorhus/awesome) ⭐ 502,185 | 🐛 105 | 📅 2026-09-02
* [awesome\_android\_UI](https://github.com/wasabeef/awesome-android-ui) ⭐ 57,431 | 🐛 39 | 📅 2026-06-05
* [awesome\_java](https://github.com/akullpp/awesome-java) ⭐ 48,911 | 🐛 6 | 📅 2026-08-24
* [awesome-adb](https://github.com/mzlogin/awesome-adb) ⭐ 12,434 | 🐛 52 | 📅 2024-12-18
* [awesome\_android(2)](https://github.com/JStumpp/awesome-android) ⭐ 12,306 | 🐛 95 | 📅 2025-10-27
...
* [Material-Animations](https://github.com/lgvalle/Material-Animations) ⭐ 13,540 | 🐛 20 | 🌐 Java | 📅 2019-04-02
...
* [awesome-design](https://github.com/gztchan/awesome-design/) ⭐ 17,481 | 🐛 61 | 📅 2024-07-04
...
* [java-design-patterns](https://github.com/iluwatar/java-design-patterns#model-view-presenter) ⭐ 94,638 | 🐛 122 | 🌐 Java | 📅 2026-08-31
...
* [Android 开发人员不得不收集的代码](https://github.com/Blankj/AndroidUtilCode) ⭐ 33,626 | 🐛 328 | 🌐 Java | 📅 2024-08-15
